...
DATA = $(wildcard *--*.sql)
EXTRA_CLEAN = src/istore_type.c src/istore_io.c src/istore_agg.c sql/istore.sql sql/bigistore.sql sql/dateistore.sql
...
src/istore_type.c src/istore_agg.c src/istore_io.c src/pairs.c sql/istore.sql sql/bigistore.sql sql/dateistore.sql:
	./generate.sh
